...
var UrlBuilder = /** @class */ (function () {
    ...
    UrlBuilder.prototype.addOptions = function (options, defaultParamName) {
        if ((0, utils_1.isString)(options) && !!defaultParamName) {
    ...
    UrlBuilder.prototype.toUrl = function () {
        ...
        if (paramNames) {
            paramNames.forEach(function (paramName) {
                ...
                var value = null;
                if ((0, utils_1.hasProp)(_this.options, key)
                    && _this.options[key] !== null) {
                    value = _this.options[key];
                }
                else if ((0, utils_1.hasProp)(_this.clientParams, key)
                    && ((_a = _this.clientParams) === null || _a === void 0 ? void 0 : _a[key]) !== null) {
        ...
        if (this.query) {
            ...
            Object.keys(this.query).forEach(function (paramName) {
                ...
                if ((0, utils_1.hasProp)(_this.options, paramName)
                    && _this.options[paramName] !== null) {
                    value = _this.options[paramName];
                }
                else if ((0, utils_1.hasProp)(_this.clientParams, paramName)
        ...
        var queryString = (0, utils_1.toQuery)(query);
